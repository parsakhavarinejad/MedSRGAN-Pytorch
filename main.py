...
def main():
    ...
    print("Loading data...")
    try:
        chest_data = glob.glob('/kaggle/input/chest-ctscan-images/Data/test/*/*.png') + \
                     glob.glob('/kaggle/input/chest-ctscan-images/Data/train/*/*.png')
    ...
    for epoch in range(epochs):
        ...
        if (epoch + 1) % 5 == 0:
            trainer.save_model(epoch + 1, empty_dir=True)
